      ...
      */
      ...
      _setContactListener = function() {
        ...
        contactListener.PostSolve = function(contact, impulse) {
          ...
          return Crafty(entityIdB).trigger("PostSolve",{
            imp: impulse,
            targetId: entityIdA,
            fixture_A: fix_A,
            fixture_B: fix_B,
    ...
    */
    ...
    return {
      ...
      */
      ...
      onHit: function(component, beginContact, after_solve, endContact) {
        var _this = this;
        if (component !== "Box2D") {
          return this;
        }
          ...
          hitData = [
            {
              ...
              fixA: data.fixture_A,
              fixB: data.fixture_B,
              contact: data.body_contact
            }
          ];
          return beginContact.call(_this, hitData);
        });
        if (typeof after_solve === "function") {
          this.bind("PostSolve", function(data) {
            var hitData;
            hitData =[{
                obj: Crafty(data.targetId),
                type: "Box2D",
            ...
            return after_solve.call(_this, hitData);
          });
        }
